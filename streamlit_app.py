...
if inflation_rate >= 13.0:
    ...
    st.warning("⚠️ **Post-Pandemic Supply Shock Simulation**\n\nSimulating heightened modern inflation pressures.")
...
st.write("Bonus: Adjust inflation rate to >5 to simulate Pandemic era")
...
with m1:
    st.metric(label="Projected Real Wealth at Horizon", value=f"${p50[-1]:,.0f}")
with m2:
